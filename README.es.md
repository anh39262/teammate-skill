...
Este skill sigue el estándar abierto [AgentSkills](SKILL.md) y funciona con cualquier agente compatible.
...
Este proyecto sigue el estándar abierto [AgentSkills](SKILL.md):
