...
Questa skill segue lo standard aperto [AgentSkills](SKILL.md) e funziona con qualsiasi agente compatibile.
...
Questo progetto segue lo standard aperto [AgentSkills](SKILL.md):
